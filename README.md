...
**📸 Screenshots:**
| Enquiry Form | Enquiry View |
|---|---|
| ![Enquiry Form](docs/screenshots/enquiry-form.png) | ![Enquiry View](docs/screenshots/enquiry-view.png) |
...
**📸 Screenshots:**
| Student Form | Student View |
|---|---|
| ![Student Form](docs/screenshots/student-form.png) | ![Student View](docs/screenshots/student-view.png) |

---

### 📚 5. Course Management

**Files:** `pages/courseform.html`, `pages/courseview.html`

**Purpose:** Add and manage courses offered by the institute.

**📸 Screenshots:**
| Course Form | Course View |
|---|---|
| ![Course Form](docs/screenshots/course-form.png) | ![Course View](docs/screenshots/course-view.png) |

---

### 🏢 6. Department Management

**Files:** `pages/department.html`, `pages/departmentview.html`

**Purpose:** Create and manage institute departments.

**📸 Screenshots:**
| Department Form | Department View |
|---|---|
| ![Department Form](docs/screenshots/department-form.png) | ![Department View](docs/screenshots/department-view.png) |

---

### 🪪 7. Designation Management

**Files:** `pages/designationform.html`, `pages/designationview.html`

**Purpose:** Add and manage staff designations/roles.

**📸 Screenshots:**
| Designation Form | Designation View |
|---|---|
| ![Designation Form](docs/screenshots/designation-form.png) | ![Designation View](docs/screenshots/designation-view.png) |

---

### 🧑‍🏫 8. Staff Registration
...
**📸 Screenshots:**
| Staff Form | Staff View |
|---|---|
| ![Staff Form](docs/screenshots/staff-form.png) | ![Staff View](docs/screenshots/staff-view.png) |

---

### 🗓️ 9. Staff Attendance
...
|---|---|
| ![Staff Attendance](docs/screenshots/staff-attendance.png) | ![Staff Attendance View](docs/screenshots/staff-attendance-view.png) |
...
|---|---|
| ![Student Attendance](docs/screenshots/student-attendance.png) | ![Student Attendance View](docs/screenshots/student-attendance-view.png) |
...
**📸 Screenshots:**
| Payroll Form | Payroll View |
|---|---|
| ![Payroll Form](docs/screenshots/payroll-form.png) | ![Payroll View](docs/screenshots/payroll-view.png) |
...
**📸 Screenshots:**
| Billing Form | Billing View |
|---|---|
| ![Billing Form](docs/screenshots/billing-form.png) | ![Billing View](docs/screenshots/billing-view.png) |
...
**📸 Screenshots:**
| Batch Form | Batch View |
|---|---|
| ![Batch Form](docs/screenshots/batch-form.png) | ![Batch View](docs/screenshots/batch-view.png) |

---

### 📜 14. Student Certificate
...
│   ├── courseform.html / courseview.html
│   ├── department.html / departmentview.html
│   ├── designationform.html / designationview.html
